class TestnetEndpoint {
  ...
  static final List<String> all = [sg1, sg2, us1, us2, jp1, jp2];
}

class DevEndpoint {
  static const String jp1 = 'https://dev-ap-jp-1.web3mq.com';
  static const String sg1 = 'https://dev-ap-singapore-1.web3mq.com';
  static const String us2 = 'https://dev-us-west-2.web3mq.com';

  static final List<String> all = [sg1, us2, jp1];
}
